...
TOOLSET := target
TARGET := pick-universe
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=pick-universe' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
$(obj).target/pick-universe.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/pick-universe.node: LIBS := $(LIBS)
$(obj).target/pick-universe.node: TOOLSET := $(TOOLSET)
$(obj).target/pick-universe.node: $(OBJS) $(obj).target/node_modules/node-addon-api/src/nothing.a FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/pick-universe.node
# Add target alias
.PHONY: pick-universe
pick-universe: $(builddir)/pick-universe.node

# Copy this to the executable output path.
$(builddir)/pick-universe.node: TOOLSET := $(TOOLSET)
$(builddir)/pick-universe.node: $(obj).target/pick-universe.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/pick-universe.node
# Short alias for building this executable.
.PHONY: pick-universe.node
pick-universe.node: $(obj).target/pick-universe.node $(builddir)/pick-universe.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/pick-universe.node
